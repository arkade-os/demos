/** WIP: need logic to intentionally submit without finalizing */
...
/** 5. Finalize pending transactions */
const finalizeResult = await wallet.finalizePendingTxs();

console.log(
  `Finalized ${finalizeResult.finalized.length}/${finalizeResult.pending.length} pending transactions:`,
  finalizeResult,
);
