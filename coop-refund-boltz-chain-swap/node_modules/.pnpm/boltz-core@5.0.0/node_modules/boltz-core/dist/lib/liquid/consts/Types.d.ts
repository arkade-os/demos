...
import type { FundingAddressTree, LiquidSwapTree, RefundDetails } from '../../consts/Types.ts';
export type LiquidBaseRefundDetails = Omit<RefundDetails, 'amount' | 'swapTree' | 'privateKey'> & TxOutput & {
...
export type LiquidLegacyRefundDetails = (LiquidScriptRefundDetails | LiquidSegwitV0RefundDetails) & {
...
export type LiquidRefundDetails = LiquidLegacyRefundDetails | LiquidTaprootRefundDetails;
